...
def finalize_turn(
    ...
    *,
    ...
    budget_exhausted = (
        api_call_count >= turn_max_iterations
                ...
                try:
                    _kb._record_task_failure(
                        ...
                        error=(
                            ...
                            f"({api_call_count}/{turn_max_iterations}) — "
                        ...
                        event_payload_extra={
                            ...
                            "budget_max": turn_max_iterations,
                        },
                    )
                    logger.info(
                        "recorded budget-exhausted failure for task %s (%d/%d)",
                        _kanban_task, api_call_count, turn_max_iterations,
                    )
                finally:
                    try:
                        _conn.close()
    ...
    _diag_args = (
        _turn_exit_reason, agent.model, api_call_count, turn_max_iterations,
